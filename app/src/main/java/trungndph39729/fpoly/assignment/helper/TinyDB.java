...
public class TinyDB {
     ...
     */
    public SnapshotStateList<String> getListString(String key) {
        String savedString = preferences.getString(key, "");
        String[] items = TextUtils.split(savedString, "‚‗‚");
        SnapshotStateList<String> stateList = new SnapshotStateList<>();
        stateList.addAll(Arrays.asList(items));
        return stateList;
    }
     ...
     */
    public SnapshotStateList<Boolean> getListBoolean(String key) {
        SnapshotStateList<String> myList = getListString(key);
        SnapshotStateList<Boolean> newList = new SnapshotStateList<>();
    ...
    public SnapshotStateList<Product> getListObject(String key) {
        Gson gson = new Gson();

        SnapshotStateList<String> objStrings = getListString(key);
        SnapshotStateList<Product> playerList = new SnapshotStateList<>();
    ...
    public void putListObject(String key, SnapshotStateList<Product> playerList) {
        checkForNullKey(key);
        Gson gson = new Gson();
